...
class CelebAMaskHQ_112x112:
    ...
    feas = [
        'skin', 'neck', 'hat', 'eye_g', 'hair', 'ear_r', 'neck_l', 'cloth',
        'l_eye', 'r_eye', 'l_brow', 'r_brow', 'nose', 'l_ear', 'r_ear',
        'mouth', 'u_lip', 'l_lip'
    ]
...
class CelebAMaskHQ_224x224:
    dataset_root = "/data/tx/CelebAMask-HQ_224x224"
    img_size = (224, 224)
    img_root = "CelebA-HQ-img"
    mask_root = "CelebAMask-HQ-mask-anno"
